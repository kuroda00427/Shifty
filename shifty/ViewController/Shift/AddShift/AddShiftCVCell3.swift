...
class AddShiftCVCell3: UICollectionViewCell,FSCalendarDelegate,FSCalendarDataSource,FSCalendarDelegateAppearance{
...
//
    ...
    func calendar(_ calendar: FSCalendar, didSelect date: Date, at monthPosition: FSCalendarMonthPosition){
        ...
        selectedDay = getDay(date)
        AddShiftVC.deadline = date

        let text = "開始日：" + changeDayToLabel(day: selectedDay)
        AddShiftVC.deadlineText = text
