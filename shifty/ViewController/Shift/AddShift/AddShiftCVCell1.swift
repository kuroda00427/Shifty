...
class AddShiftCVCell1: UICollectionViewCell,FSCalendarDelegate,FSCalendarDataSource,FSCalendarDelegateAppearance{
...
//
    ...
    func calendar(_ calendar: FSCalendar, didSelect date: Date, at monthPosition: FSCalendarMonthPosition){
        ...
        AddShiftVC.endDate = date

        let text = "最終日：" + changeDayToLabel(day: selectedDay)
        AddShiftVC.endDayText = text
