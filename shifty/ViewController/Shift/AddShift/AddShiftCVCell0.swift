...
class AddShiftCVCell0: UICollectionViewCell,FSCalendarDelegate,FSCalendarDataSource,FSCalendarDelegateAppearance{
...
//
    ...
    func calendar(_ calendar: FSCalendar, didSelect date: Date, at monthPosition: FSCalendarMonthPosition){
        ...
        AddShiftVC.startDate = date
        let text = "開始日：" + changeDayToLabel(day: selectedDay)
        AddShiftVC.startDayText = text
